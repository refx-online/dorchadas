...
export async function deleteExistingImages(directory: string, userId: number, extensions: string[] = ['jpg', 'jpeg', 'png', 'gif']) {
...
export function findExistingImage(directory: string, userId: number): { path: string; contentType: string } | null {
    const formats = [
