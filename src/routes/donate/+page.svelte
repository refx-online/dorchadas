	...
	<div class="container mx-auto px-4 py-16 relative z-[2]">
		...
		<div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
			{#each donationOptions as donor}
				<div class="relative group">
					<div
						class="{donor.backgroundColor} rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-4xl p-6"
					>
		...
		<div class="text-center mt-12 max-w-2xl mx-auto">
			...
			<p class="text-surface-600 dark:text-surface-300">
				{__(
					'Your donations help us cover server costs, development time, and continue improving {{val}}. Every contribution, big or small, makes a difference!',
					$userLanguage,
					{
						val: appName
					}
