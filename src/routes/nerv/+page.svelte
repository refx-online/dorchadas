...
<style>
	...
	@keyframes welcome-pulse {
		...
		50% {
			text-shadow: 0 0 20px rgba(255, 62, 0, 0.8);
		}
	}
	...
	.account-item::after {
		...
		width: 100%;
		height: 100%;
		background: linear-gradient(90deg, transparent, rgba(255, 62, 0, 0.2), transparent);
	...
	.nerv::after {
		...
		right: 0;
		bottom: 0;
		background-image: radial-gradient(circle at 2px 2px, rgba(255, 62, 0, 0.1) 1px, transparent 0);
