<script lang="ts">
    ...
    const bbcodes = [
        ...
        },
        {
            ...
            example: "[spotify]https://open.spotify.com/track/6LY9viOYIMvzdOIxBQDWdI?si=dc840cad910f433d[/spotify]"
        },
        {
            name: "Audio",
...
<div class="container mx-auto p-6 space-y-8">
    <header class="space-y-4">
        ...
        <p class="text-surface-400">
            {__("BBCode is a markup language used for formatting posts and messages. Below is a comprehensive guide to all available BBCode tags and their usage. ", $userLanguage)}
