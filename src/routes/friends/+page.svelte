                    ...
                    {#each data.friends as friend (friend.id)}
                        ...
                        >
                            ...
                            <div class="relative z-10 flex items-center">
                                ...
                                <div class="flex-grow">
                                    {#if !playerStatusMap[friend.id]?.online && playerStatusMap[friend.id]?.last_seen}
                                        <div class="text-xs text-surface-300 mb-1">
                                            <Time
                                                timestamp={dayjs(t(playerStatusMap[friend.id]?.last_seen)).locale($userLanguage)}
                                                relative
                                            />
                                        </div>
                                    {/if}
                                ...
                                <div class="ml-auto">
                                    <a href="/u/{friend.id}" class="btn btn-sm variant-soft-primary flex items-center gap-2">
                                        <User class="w-4 h-4" />
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="relative z-10 flex items-center">
                                ...
                                <div class="flex-grow">
                                    {#if !playerStatusMap[follower.id]?.online && playerStatusMap[follower.id]?.last_seen}
                                        <div class="text-xs text-surface-300 mb-1">
                                            <Time
                                                timestamp={dayjs(t(playerStatusMap[follower.id]?.last_seen)).locale($userLanguage)}
                                                relative
                                            />
                                        </div>
                                    {/if}
                                ...
                                <div class="ml-auto">
                                    <a href="/u/{follower.id}" class="btn btn-sm variant-soft-primary flex items-center gap-2">
                                        <User class="w-4 h-4" />
                                    </a>
                                </div>
                            </div>
