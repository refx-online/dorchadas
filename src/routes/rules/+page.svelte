    ...
    >
        ...
        <ol class="list-decimal">
            ...
            <li>
                ...
                <p>
                    {t('Using any form of cheating software, hacks, or external assistance on vanilla | relax | autopilot mode is strictly prohibited and will result in a permanent ban.')}
                </p>
            </li>
        </ol>
        ...
        <p>{t('To appeal your punishment, please direct message one of our moderators on our Discord. They will reach out to you, discussing your punishment and a more detailed appeal from your side.')}</p>
    </section>
</div>
