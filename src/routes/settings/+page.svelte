    ...
    const handleUsernameSubmit: SubmitFunction = () => {
        ...
        return async ({ result, update }) => {
            if (result.type === 'success') {
                ...
                showMessage(result.data?.message || __('Failed to update username', $userLanguage), 'error');
            }
            isLoading = false;
            await update();
        };
    ...
    const handleMetricSubmit: SubmitFunction = () => {
        ...
        return async ({ result, update }) => {
            if (result.type === 'success') {
                ...
                showMessage(result.data?.message || __('Failed to update ranking metric', $userLanguage), 'error');
            }
            isLoading = false;
        };
    };
...
<div class="container mx-auto p-4 max-w-4xl">
    <!-- Message Alert -->
    {#if message}
        <div class="alert {messageType === 'success' ? 'variant-filled-success' : 'variant-filled-error'} mb-6 transition-all">
            <span>{message}</span>
        </div>
    {/if}
            ...
            {#if data.currentUser}
                <section>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                            ...
                            <div class="flex-1 space-y-3">
                                ...
                                >
                                    {isLoading ? __('Uploading...', $userLanguage) : __('Upload Avatar', $userLanguage)}
                                </button>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-4">
                            <div class="w-full h-48 overflow-hidden rounded-lg border-2 border-surface-300-600-token">
                                <img
                            ...
                            <div class="space-y-3">
                                ...
                                >
                                    {isLoading ? __('Uploading...', $userLanguage) : __('Upload Cover', $userLanguage)}
                                </button>
                                <p class="text-sm opacity-75">
                                    {__('Maximum size: 5MB. Supported formats: JPG, PNG, GIF', $userLanguage)}
                                </p>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                ...
                                >
                                    {isLoading ? __('Uploading...', $userLanguage) : __('Upload Background', $userLanguage)}
                                </button>
                                <p class="text-sm opacity-75">
                                    {__('Maximum size: 5MB. Supported formats: JPG, PNG, GIF', $userLanguage)}
                                </p>
                ...
                <section>
                    ...
                    <div class="mb-8">
                        ...
                        >
                            ...
                            >
                                {isLoading ? __('Updating...', $userLanguage) : __('Change Username', $userLanguage)}
                            </button>
                        </form>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <button
                                ...
                                disabled={isLoading}
                            >
                                {isLoading ? __('Updating...', $userLanguage) : __('Update Ranking Metric', $userLanguage)}
                            </button>
                        </form>
                    </div>
                </section>
